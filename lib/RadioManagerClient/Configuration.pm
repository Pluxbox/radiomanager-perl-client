...
#
package RadioManagerClient::Configuration;
...
=head1 Name
        ...
        RadioManagerClient::Configuration - holds the configuration for all RadioManagerClient Modules
...
default: https://staging.radiomanager.pluxbox.com/api/v2
...
sub new {
	...
	# base_url
        $p{base_url} //= 'https://staging.radiomanager.pluxbox.com/api/v2';
