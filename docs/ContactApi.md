...
# **list_contacts**
> ContactResults list_contacts(page => $page, model_type_id => $model_type_id, tag_id => $tag_id, item_id => $item_id, _external_station_id => $_external_station_id)
...
eval { 
    my $result = $api_instance->list_contacts(page => $page, model_type_id => $model_type_id, tag_id => $tag_id, item_id => $item_id, _external_station_id => $_external_station_id);
    print Dumper($result);
};
if ($@) {
