...
#
package RadioManagerClient::ApiClient;
...
sub _new_instance
{
    ...
    my (%args) = (
        ...
        'base_url' => 'http://staging.radiomanager.pluxbox.com/api/v2',
        @_
    );
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("RadioManagerClient::Object::$class")->new;
        if (ref $data eq "HASH") {
...
sub update_params_for_auth {
    ...
    foreach my $auth (@$auth_settings) {
        ...
        elsif ($auth eq 'API Key') {
            
            my $api_key = $self->get_api_key_with_prefix('api-key');
            if ($api_key) {
