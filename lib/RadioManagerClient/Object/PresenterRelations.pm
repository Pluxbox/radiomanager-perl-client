...
#
package RadioManagerClient::Object::PresenterRelations;
...
__PACKAGE__->method_documentation({
    'programs' => {
        datatype => 'PresenterRelationsPrograms',
        base_name => 'programs',
        description => '',
        format => '',
        read_only => '',
    ...
    'broadcasts' => {
        datatype => 'PresenterRelationsBroadcasts',
    ...
    'model_type' => {
        datatype => 'PresenterRelationsModelType',
...
__PACKAGE__->openapi_types( {
    ...
    'model_type' => 'PresenterRelationsModelType'
} );
