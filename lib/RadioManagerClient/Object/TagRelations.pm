...
#
package RadioManagerClient::Object::TagRelations;
...
__PACKAGE__->method_documentation({
    'broadcasts' => {
    	datatype => 'TagRelationsBroadcasts',
